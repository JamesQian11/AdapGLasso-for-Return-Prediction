...
if __name__ == "__main__":
    ...
    noise_std = 20
    # --------------------
    x = np.random.standard_normal((num_datapoints, 15))
    # print(x)
    # x = np.random.rand(1000, 8)

    window_container = []
    # x_trans
    x_trans,x_rank = myasgl.process_x_matrix(x, L)
    # Rank Transformation
    ...
    print('x', x_trans_wind.shape)
    print('x_out', x_trans_out.shape)
    print('x_trans', x_rank_wind.shape)
    print('y', y_wind.shape)
